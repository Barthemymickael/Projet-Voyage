...
{
  id: 't67',
  date: 'Jour 67 (23 961 pas)',
  title: 'Quartier Shinjuku et baseball',
  description:
    'Une journée intense à Shinjuku, exploration du quartier, match de baseball et boite de nuit.',
  bullets: [
    'Découverte de Shinjuku',
    'Tower Records',
    'Balade dans le quartier et statue de Godzilla',
    'Pause au Kabukicho Tower',
    'Promenade au Shinjuku Gyoen Park',
    'Match de baseball Tokyo Yakult Swallows vs Yomiuri Giants',
    'Session dans un batting center',
    'Dîner chez Sushiro',
...
},
{
  ...
  "day": 67,
  "title": "Quartier Shinjuku et baseball",
  "excerpt": `Découverte du quartier de Shinjuku !

À peine sorti de la station, je me dirige vers le centre commercial Flags. Je monte directement au 9e et 10e étage pour aller chez Tower Records, un peu comme la Fnac mais spécialisé dans la musique.

Je découvre pas mal de vinyles et de CD. Je m’achète un CD du groupe Warrant, que je n’ai pas arrêté d’écouter depuis le début de mon voyage.

Parfait pour lier un objet à mon voyage.

À la suite de ça, je me balade dans le quartier de Shinjuku et me rapproche de l’immense statue de Godzilla, iconique du quartier.

Je rentre ensuite dans l’immense building Tokyo Kabukicho Tower et je me pose une petite heure chez Starbucks.

Honnêtement, le quartier de jour est un poil ennuyant. Mis à part des boutiques, des cafés et des restaurants, rien de bien passionnant.

Ce qui est impressionnant, ça reste la grandeur des buildings, les couleurs des devantures et les écrans géants.

L’ambiance de nuit doit être vraiment plus mémorable, plus cinématographique.

Balade d’1h au Shinjuku Gyoen Park. Pour 2,50 €, je trouve que c’est l’un des parcs les plus beaux et les plus apaisants de Tokyo !

Plein de jardins différents, mais évidemment le jardin japonais reste le plus apaisant.

Je ne suis pas resté plus longtemps dans le parc car à 18h, j’avais une activité que j’avais réservée et que j’attendais depuis longtemps :

Voir un match de baseball d’une équipe de Tokyo.

Ainsi, j’ai pris ma place pour voir le match Tokyo Yakult Swallows vs Yomiuri Giants.

L’ambiance était cool : 3h de match, 2 pintes, 1 kebab et, vers la fin, une ambiance électrique !

En sortant, je retourne dans le quartier de Shinjuku où l’ambiance est maintenant différente : des lumières de partout et surtout des milliers de gens dans les rues.

J’en profite pour tester une activité sympa et pas chère dans un batting center.

Une machine automatique qui lance des balles de baseball, et le but est d’en renvoyer le plus possible avec la batte.

Hyper sympa. Je me suis mis sur le niveau débutant, mais la vitesse était quand même assez dure. J’ai dû toucher une vingtaine de balles sur 50.

Après cette petite parenthèse, je décide de manger des sushis pour ce soir, alors je me dirige vers Sushiro.

En sortant du restaurant vers 22h30, je décide un peu par instinct et par hasard de tester une boîte de nuit assez connue du quartier : le T2 Night Club.

Ambiance ultra cool, musique techno et quelques sons plus commerciaux.

Superbe expérience de 23h à 4h30 du matin.

Retour via le premier métro, lever de soleil sur la capitale, et un monde fou sur les quais, tous en train de rentrer de soirée !
