      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* ================= FULL TEXT ================= */}
            <section className="max-w-3xl mx-auto px-6 py-20 space-y-10 text-white/80 leading-relaxed text-base md:text-lg whitespace-pre-line">
